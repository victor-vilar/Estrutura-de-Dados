...
//	}
	...
	//adicionar
	public boolean adicionar(T string) {
	...
	public void adicionar(T string, int indice) throws IllegalArgumentException {
	...
	private void aumentaCapacidade() {
		if(this.tamanhoDoVetor == this.elementos.length) {
			T[] novoVetor = (T[])new Object[this.tamanhoDoVetor * 2];
	...
	public int UltimoIndice(T elemento) {
		 for(int x = tamanhoDoVetor-1; x > 0; x--) {
			 if(this.elementos[x].equals(elemento)) {
				 return x;
			 }
		 }
		 return -1;
